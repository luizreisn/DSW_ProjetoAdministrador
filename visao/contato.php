...
<head>
    ...
    <link rel="stylesheet" href="../visao/contato.css">
        ...
        <div class="container">
            ...
            <div>
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../perfil/perfil.html">Perfil</a></li>
                    <li class="nav-item active"><a class="nav-link" href="../visao/contato.php">Form Contato</a></li>
                    <li class="nav-item"><a class="nav-link" href="../trabalhe/trabalhe.html">Form Trabalhe</a></li>
                    <li class="nav-item"><a class="nav-link" href="../login/login.html">Sair <i class="fas fa-sign-out-alt"></i></a></li>
                </ul>
            </div>
        </div>
    </nav>
                ...
                <form action="../controle/controleContato.php" method="POST">
                    <div class="input-group mt-3">
                        ...
                        <div class="input-group-append">
                            <input type="submit" name="buscarEmail" value="Buscar" class="btn btn-primary">
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="col">
                <form action="../controle/controleContato.php" method="POST">
                    <div class="input-group mt-3">
                        ...
                        <div class="input-group-append">
                            <input type="submit" name="buscarNome" value="Buscar" class="btn btn-primary">
                        </div>
                    </div>
                </form>
            </div>
                ...
                <form action="../controle/controleContato.php" method="POST">
                    <div class="form-group form-check-inline">
                        <div class="col text-center">
                            <input type="submit" name="listar" value="Listar todos" class="btn btn-primary">
                        </div>
                    </div>
                </form>
            </div>
