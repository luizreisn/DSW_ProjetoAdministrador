...
<head>
    ...
    <link href="../visao/css/ca.css" rel="stylesheet">
        ...
        <div class="container">
            ...
            <div>
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a class="nav-link" href="../visao/login.php">Login</a></li>
                </ul>
            </div>
        </div>
    </nav>
			...
			<div class="d-flex justify-content-center">
				<form action="../controle/controleCadastro.php" method="POST">
					<div class="input-group">
						...
						<input type="text" name="nome" id="nome" class="form-control" placeholder="nome" pattern="[A-Za-zÀ-ú'Ç-ç\s]+$" title="Apenas letras são permitidas!" required>
					</div>
                    <div class="input-group">
						<div class="input-group-append">
							<span class="input-group-text"><i class="fas fa-calendar-day"></i></span>
						</div>
						<input type="date" name="nascimento" id="nascimento" class="form-control" max="2003-01-01" min="1921-01-01" title="Você deve ser maior de 18 anos!" required>
					</div>
                    <div class="input-group">
						<div class="input-group-append">
							<span class="input-group-text"><i class="fas fa-user"></i></span>
						</div>
						<input type="tel" name="celular" id="celular" class="form-control" placeholder="celular xx xxxxx-xxxx" pattern="[0-9]{2}\s[0-9]{5}-[0-9]{4}" title="Formato de celular incorreto! Colocar espaço entre o ddd, e colocar o simbolo -" required>
					</div>
					<div class="input-group">
						<div class="input-group-append">
					...
					<div class="d-flex justify-content-center">
                        <a class="login" href="../visao/cadastro.php">Já possui cadastro? Faça Login aqui...</a>
                    </div>

					<br>

					<div class="d-flex justify-content-center">
						<button type="submit" name="cadastrar" id="cadastrar" class="btn btn-success btn-block">Cadastrar</button>
					</div>
					<div class="d-flex justify-content-center">
